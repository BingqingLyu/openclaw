...
export function evaluateSessionFreshness(params: {
  ...
  if (updatedAt === undefined) {
    // Persisted session stores can contain legacy/manual entries without a
    // usable activity timestamp. Treat those as stale instead of formatting an
    // invalid date through the human-day helpers.
    return {
      fresh: false,
      dailyResetAt,
    };
